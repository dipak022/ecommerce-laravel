							...
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									...
									{{-- <ul class="check-box-list">
										<li>
											<label class="checkbox-inline" for="1"><input name="news" id="1" type="checkbox">20 TK  - 50 TK<span class="count">(3)</span></label>
										</li>
										<li>
											<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox">50 TK- 100 TK<span class="count">(5)</span></label>
										</li>
										<li>
											<label class="checkbox-inline" for="3"><input name="news" id="3" type="checkbox">100 TK - 250 TK<span class="count">(8)</span></label>
										</li>
									</ul> --}}
								</div>
								<!--/ End Shop By Price -->
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">{{number_format($product->price,2)}} TK</del>   {{number_format($org,2)}}  TK</p>                                                
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
